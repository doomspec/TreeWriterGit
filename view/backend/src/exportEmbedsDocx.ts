...
import { buildTableMarkdownExport } from "./exportEmbeds.js";
import type { ExportEmbedResult } from "./exportEmbeds.js";
...
function stripPandocTableLabel(markdown: string): string {
