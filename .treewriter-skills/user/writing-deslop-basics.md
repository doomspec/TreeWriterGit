...
description: Deslop a TreeWriter draft.md — strip AI tells (em dashes, filler, hype) for human scientific voice. Triggers include deslop, de-AI, AI slop, polish prose. For structure use scientific-writing-framework.
---
